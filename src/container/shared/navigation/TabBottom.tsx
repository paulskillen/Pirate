...
const TabBottom: React.FC<ITabBottomProps> = ({ id }) => {
    return (
        <div
            className="tab-bottom bg-primary  z-20 fixed flex items-center justify-center gap-x-24 -bottom-3 left-0 right-0 h-5 pb-3 rounded-tl-3xl rounded-tr-3xl pt-1 border-t-2 border-t-slate-500"
